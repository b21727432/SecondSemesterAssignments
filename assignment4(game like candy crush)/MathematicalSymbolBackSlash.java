...
public class MathematicalSymbolBackSlash extends Jewel {

    public MathematicalSymbolBackSlash(IGameGrid gameGrid, int row, int column) {
    ...
    public ArrayList<Jewel> go(int row, int column) {
        ...
        try {
            ...
            if (getName().equals(jewel.getName())) {
                ...
                if ("/".equals(jewel1.getName()) || "-".equals(jewel1.getName()) || "+".equals(jewel1.getName()) || "|".equals(jewel1.getName()) || getName().equals(jewel1.getName())) {
